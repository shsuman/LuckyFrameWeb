package com.luckyframe.project.tool.gen.controller;
...
import com.luckyframe.project.tool.gen.service.IGenService;
...
public class GenController extends BaseController
{
    ...
    public void genCode(HttpServletResponse response, @PathVariable String tableName) throws IOException
    {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"LF_GenerateCode.zip\"");
